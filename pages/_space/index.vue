<template>
  <div>
    <base-header class="pb-6" type>
      ...
      <div class="row">
        <TopWidget :value="summary.checkins" img="/img/icon-user.png" text="Members Checked In" />
        ...
        />
        <TopWidget :value="summary.bookings" img="/img/icon-discount.png" text="Bookings" />
        <TopWidget
