      ...
      <base-header 
        ...
        <div class="d-flex justify-content-between align-items-center py-4">
          ...
          <button 
            ...
            <span class="fa fa-plus" /> Create Invoice
          </button>
        </div>
      </base-header>
          ...
          <card>
            <div class="row">
              ...
              <div class="col-md-5">
                ...
                <div 
                  v-for="(item, index) in addInvoice.items" 
                  :key="index" 
                ...
                <modal :show.sync="modals.classic">
                  ...
                  <template slot="footer">
                    <b-button 
                      type="button" 
                      class="ml-auto" 
                      @click="addInvoiceItem">Save</b-button>
                  </template>
                </modal>
...
export default {
  ...
  async asyncData(vm) {
    ...
    const { data } = await vm.$company.getOneCompany(id)
    vm.store.commit('company/setCompanies', data)
  },
  data() {
    return {
      invoiceItem: { description: null, amount: null, itemIndex: null },
      addInvoice: {
        description: '',
        company_id: '',
        days_until_due: 0,
