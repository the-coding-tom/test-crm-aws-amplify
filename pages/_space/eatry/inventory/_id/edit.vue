<template>
  <div>
    <b-form @submit.prevent="editInventory">
      <base-header 
        class="pb-6" 
        type>
        <div class="d-flex justify-content-between align-items-center py-4">
          <MainTitle title="Edit Inventory" />
          <b-button 
            :disabled="loading" 
            class="btn btn-primary text-white" 
            type="submit">
            <i class="fa fa-save" /> Update Inventory
          </b-button>
        </div>
      </base-header>
      ...
      <div class="container-fluid mt--6">
        <div class="card-deck flex-column flex-xl-row">
          <card>
            <h3 class="mr-b-20">Update Inventory</h3>
            <div class="row">
              <div class="col-md-6">
...
export default {
  ...
  async asyncData({ store, $eatry, error, params }) {
    const { id } = params
