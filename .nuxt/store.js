...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/community.js'), 'community.js')
  resolveStoreModules(require('../store/company.js'), 'company.js')
  resolveStoreModules(require('../store/eatry.js'), 'eatry.js')
  resolveStoreModules(require('../store/events.js'), 'events.js')
  resolveStoreModules(require('../store/invoice.js'), 'invoice.js')
  resolveStoreModules(require('../store/memberships.js'), 'memberships.js')
  resolveStoreModules(require('../store/plans.js'), 'plans.js')
  resolveStoreModules(require('../store/promotions.js'), 'promotions.js')
  resolveStoreModules(require('../store/resources.js'), 'resources.js')
  resolveStoreModules(require('../store/space.js'), 'space.js')
  resolveStoreModules(require('../store/tags.js'), 'tags.js')
  resolveStoreModules(require('../store/wellness.js'), 'wellness.js')
