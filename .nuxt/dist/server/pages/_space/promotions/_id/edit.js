...
// CONCATENATED MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/promotions/_id/edit.vue?vue&type=script&lang=js&
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    return await $promotion.getPromotion(id).then(({
      data
    }) => {
      console.log('------------------------------------');
      console.log(data);
      ...
      return {
        ...
        orderingFoodAndDrinks: data.allowed_usage_areas.includes('food_ordering'),
  ...
  methods: {
    editPlan() {
      ...
      this.$promotion.updatePromotion(id, this.promotion).then(({
        data: {
          data
        }
      }) => {
        this.$bvToast.toast(`Promotion ~${this.promotion.name}~ updated successfully`, {
          title: 'Success',
          variant: 'success',
          solid: true
        });
...
// CONCATENATED MODULE: ./pages/_space/promotions/_id/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_space/promotions/_id/edit.vue
