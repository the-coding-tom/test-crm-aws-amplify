...
/* harmony import */ var _components_argon_core_Breadcrumb_RouteBreadcrumb__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
/* harmony import */ var _components_shack_MembersCheckin_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(230);
...
const moment = __webpack_require__(87);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    MembersCheckin: _components_shack_MembersCheckin_vue__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"],
    ...
    QrcodeStream: () => __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, 185))
  },
  ...
  async asyncData({
    ...
    try {
      ...
      const checkinFilter = `?filter[status]=checkin&filter[checkin_timestamp]=${moment().tz("America/Los_Angeles").format('YYYY-MM-DD')},${moment().add(1, 'days').tz("America/Los_Angeles").format('YYYY-MM-DD')}&page=${route.query.page}&sort=-id`;
      let imeta, ilinks;
  ...
  mounted() {
    const data = {
      ...
      to: this.$moment().add(1, 'days').tz("America/Los_Angeles").format('YYYY-MM-DD')
    };
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/shack/MembersCheckin.vue?vue&type=template&id=1ed26b52&
...
var row = ref.row;
return [(row.status == 'checkin')?_c('div',{staticClass:"sh-vflex"},[(row.membership)?_c('div',[_c('nuxt-link',{attrs:{"to":{
                name: 'space-directory-id',
                params: { id: row.member.id },
              }}},[_vm._v("\n              "+_vm._s(row.first_name + ' ' + row.last_name)),(row.member.prefix_type === '0')?_c('b-badge',{attrs:{"pill":"","variant":"secondary"}},[_c('i',{staticClass:"fa fa-star"})]):_vm._e()],1),_vm._v(" "),_c('br'),_vm._v("\n            "+_vm._s(row.company)+"\n          ")],1):_c('div',[_vm._v("\n            "+_vm._s(row.first_name + ' ' + row.last_name)+" "),_c('br'),_vm._v("\n            "+_vm._s(row.company)+"\n          ")])]):_vm._e()]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"Type","prop":"type","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
              var row = ref.row;
return [(row.status == 'checkin')?_c('div',[_vm._v("\n          "+_vm._s(row.type)+"\n        ")]):_vm._e()]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"For","prop":"member_id","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
              var row = ref.row;
return [(row.type == 'guest' && row.status == 'checkin')?_c('div',{staticClass:"float-left"},[_vm._v("\n          "+_vm._s(((row.member.first_name) + " " + (row.member.last_name)))+"\n        ")]):_vm._e()]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"Meeting Guest","prop":"meeting_guest","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
              var row = ref.row;
return [(row.meeting_guest && row.status == 'checkin')?_c('b-badge',{attrs:{"variant":"primary"}},[_vm._v("Yes")]):_vm._e()]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"Timestamp: Check-in / Check-out","min-width":"100px","prop":"method","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
              var row = ref.row;
return [(row.status == 'checkin')?_c('span',[_vm._v(_vm._s(row.checkin_timestamp)+" / "+_vm._s(row.checkout_timestamp))]):_vm._e()]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"Check","prop":"status","sortable":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
              var row = ref.row;
return [(row.status == 'checkin')?_c('b-button',{attrs:{"disabled":_vm.loading,"variant":"orange"},on:{"click":function($event){return _vm.checkout(row)}}},[_vm._v("Check-Out")]):_vm._e()]}}])})],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/shack/MembersCheckin.vue?vue&type=template&id=1ed26b52&

// EXTERNAL MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/shack/MembersCheckin.vue?vue&type=script&lang=js&
var MembersCheckinvue_type_script_lang_js_ = __webpack_require__(114);

// CONCATENATED MODULE: ./components/shack/MembersCheckin.vue?vue&type=script&lang=js&
 /* harmony default export */ var shack_MembersCheckinvue_type_script_lang_js_ = (MembersCheckinvue_type_script_lang_js_["a" /* default */]); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/shack/MembersCheckin.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  shack_MembersCheckinvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var MembersCheckin = __webpack_exports__["a"] = (component.exports);
...
var component = Object(componentNormalizer["a" /* default */])(
  _space_checkinsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var checkins = __webpack_exports__["default"] = (component.exports);
