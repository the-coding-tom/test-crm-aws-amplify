...
/* harmony import */ var _components_shack_MembersCheckin_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(223);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  async asyncData({
    ...
    try {
      ...
      const checkinFilter = `?filter[status]=checkin&filter[created_at]=${moment().format('YYYY-MM-DD')},${moment().add(1, 'days').format('YYYY-MM-DD')}&page=${route.query.page}`;
      let imeta, ilinks;
