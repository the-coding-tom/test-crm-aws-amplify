...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL) {/* harmony import */ var _components_argon_core_Breadcrumb_RouteBreadcrumb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/* harmony import */ var _components_shack_MembersTable_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(180);
/* harmony import */ var _components_shack_MainTitle_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94);
/* harmony import */ var _components_shack_SectionTitle_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(95);
/* harmony import */ var _components_shack_SearchForm_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(105);
/* harmony import */ var _util_url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(106);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  async asyncData({
    ...
    const filter = `filter[status]=invited&include=profile,primaryPlan&page=${route.query.page}`;
  ...
  components: {
    MainTitle: _components_shack_MainTitle_vue__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"],
    SearchForm: _components_shack_SearchForm_vue__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"],
    SectionTitle: _components_shack_SectionTitle_vue__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"],
    MembersTable: _components_shack_MembersTable_vue__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"],
    RouteBreadCrumb: _components_argon_core_Breadcrumb_RouteBreadcrumb__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]
  },
  data: () => ({
    searchTerm: '',
    loading: false
  ...
  methods: {
    exportData() {
      this.$membership.export().then(res => {
        ...
        a.download = 'invited-members.csv'; // Automatically click the link
    ...
    next() {
      ...
      const params = Object(_util_url__WEBPACK_IMPORTED_MODULE_5__[/* getQueryParams */ "a"])(next);
    ...
    prev() {
      ...
      const params = Object(_util_url__WEBPACK_IMPORTED_MODULE_5__[/* getQueryParams */ "a"])(prev);
      this.$router.push(params);
      location.href = location.origin + this.$route.path + params;
    },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/memberships/index.vue?vue&type=template&id=3d7b9c81&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('base-header',{staticClass:"pb-6",attrs:{"type":""}},[_c('div',{staticClass:"d-flex justify-content-between align-items-center py-4"},[_c('MainTitle',{attrs:{"subtitle":((_vm.meta.total) + " Invites"),"title":"Members"}}),_vm._v(" "),_c('SearchForm',{attrs:{"loading":_vm.loading},on:{"search":_vm.search}}),_vm._v(" "),_c('div',[_c('b-button',{staticClass:"text-primary",attrs:{"variant":"transparent"},on:{"click":_vm.exportData}},[_c('i',{staticClass:"fa fa-file-export"}),_vm._v(" Export")]),_vm._v(" "),_c('b-button',{attrs:{"to":{ name: 'space-memberships-add' },"variant":"primary"}},[_vm._v("Add Member")])],1)],1)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container-fluid mt--6\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col\">","</div>",[_c('MembersTable',{attrs:{"members":_vm.members}})],1)]),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[_c('base-pagination',{attrs:{"total":_vm.meta.total,"per-page":_vm.meta.per_page,"value":_vm.meta.current_page,"align":"center"},on:{"next":_vm.next,"prev":_vm.prev,"input":_vm.changePage}})],1)],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_space/memberships/index.vue?vue&type=template&id=3d7b9c81&

// EXTERNAL MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/memberships/index.vue?vue&type=script&lang=js&
var membershipsvue_type_script_lang_js_ = __webpack_require__(128);

// CONCATENATED MODULE: ./pages/_space/memberships/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var _space_membershipsvue_type_script_lang_js_ = (membershipsvue_type_script_lang_js_["a" /* default */]); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_space/memberships/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _space_membershipsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
