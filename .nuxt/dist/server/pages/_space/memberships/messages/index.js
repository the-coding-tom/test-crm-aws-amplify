...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/memberships/messages/index.vue?vue&type=template&id=02b7d4f1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('base-header',{staticClass:"pb-6",attrs:{"type":""}},[_c('div',{staticClass:"d-flex justify-content-between align-items-center py-4"},[_c('MainTitle',{attrs:{"title":"Messages","subtitle":"All"}}),_vm._v(" "),_c('b-button',{attrs:{"to":{name: 'space-memberships-messages-create'},"variant":"primary"}},[_c('i',{staticClass:"fa fa-paper-plane"}),_vm._v(" New Email")])],1)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container-fluid mt--6 mr-b-30\">","</div>",[_vm._ssrNode("<div class=\"card-deck flex-column flex-xl-row\">","</div>",[_vm._ssrNode("<div class=\"card\">","</div>",[_c('b-table',{attrs:{"fields":_vm.fields,"items":_vm.data,"striped":"","hover":"","show-empty":""},on:{"row-clicked":_vm.rowClicked},scopedSlots:_vm._u([{key:"cell(emails)",fn:function(row){return [_vm._v("\n            "+_vm._s(_vm.getEmail(row.value))+"\n          ")]}}])})],1)]),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[_c('base-pagination',{attrs:{"total":_vm.meta.total,"per-page":_vm.meta.per_page,"value":_vm.meta.current_page,"align":"center"},on:{"next":_vm.next,"prev":_vm.prev}})],1),_vm._ssrNode(" "),_c('b-link',{on:{"click":function($event){return _vm.$router.go(-1)}}},[_c('i',{staticClass:"fa fa-angle-left mr-r-10"}),_vm._v(" Back")])],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_space/memberships/messages/index.vue?vue&type=template&id=02b7d4f1&
...
// CONCATENATED MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/memberships/messages/index.vue?vue&type=script&lang=js&
...
/* harmony default export */ var messagesvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    return await $email.getAllEmails().then(({
      data,
      meta,
      links
    }) => {
...
// CONCATENATED MODULE: ./pages/_space/memberships/messages/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var memberships_messagesvue_type_script_lang_js_ = (messagesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_space/memberships/messages/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  memberships_messagesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
