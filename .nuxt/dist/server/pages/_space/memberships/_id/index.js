...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    updateMembership() {
      ...
      this.data.paid_by = this.paid_by; // Fixed bug using this line

      if (this.data.assigned_admin) {
        var _this$selectedAdmin;

        this.data.assigned_admin = (_this$selectedAdmin = this.selectedAdmin) !== null && _this$selectedAdmin !== void 0 ? _this$selectedAdmin : this.data.assigned_admin.uuid;
      } else {
        var _this$selectedAdmin2;

        this.data.assigned_admin = (_this$selectedAdmin2 = this.selectedAdmin) !== null && _this$selectedAdmin2 !== void 0 ? _this$selectedAdmin2 : this.data.assigned_admin.uuid;
      }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/memberships/_id/index.vue?vue&type=template&id=02575b8e&
...
// CONCATENATED MODULE: ./pages/_space/memberships/_id/index.vue?vue&type=template&id=02575b8e&
...
var _idvue_type_script_lang_js_ = __webpack_require__(164);
