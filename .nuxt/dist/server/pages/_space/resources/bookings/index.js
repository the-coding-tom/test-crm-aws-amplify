...
/* harmony import */ var _components_bookings_Modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(233);
...
/* harmony import */ var vuex_map_fields__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(23);
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data() {
    return {
      ...
      calendarPlugin: 'resourceTimelineMonth,resourceTimelineWeek,listWeek,resourceTimelineDay',
  ...
  methods: {
    fetchResources(fetchInfo, successCallback, failureCallback) {
      this.$resource.getAllBookableResources().then(({
        data: {
          data
        }
      }) => {
    ...
    eventClick(e) {
      console.log(this.$moment(e.start).utc().format());
      this.bookdata.from = this.$moment(e.start).utc().format('YYYY-MM-DD HH:mm');
      this.bookdata.to = this.$moment(e.end).utc().format('YYYY-MM-DD HH:mm');
    ...
    viewSwitched(eventData) {//this.currentViewType =
...
var Modalvue_type_script_lang_js_ = __webpack_require__(145);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/resources/bookings/index.vue?vue&type=template&id=1b85ad3e&
...
// CONCATENATED MODULE: ./pages/_space/resources/bookings/index.vue?vue&type=template&id=1b85ad3e&
...
var bookingsvue_type_script_lang_js_ = __webpack_require__(144);
