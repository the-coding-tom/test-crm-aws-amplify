...
/* harmony import */ var _components_shack_UploadButton_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(103);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    UploadButton: _components_shack_UploadButton_vue__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"],
  ...
  methods: {
    ...
    addWellness() {
      ...
      let slotList = _.sortBy(_.map(slots, o => {
        return { ...o,
          duration
        };
      }), ['day', 'start']);
      ...
      this.toggleLoading();
      this.$wellness.addWellnessSession(payload).then(({
        data
      }) => {
...
var component = Object(componentNormalizer["a" /* default */])(
  wellness_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
