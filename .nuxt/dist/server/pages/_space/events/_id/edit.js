...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/events/Room.vue?vue&type=template&id=786a2106&
...
// CONCATENATED MODULE: ./components/events/Room.vue?vue&type=template&id=786a2106&
...
/* harmony default export */ var Roomvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getRooms(link) {
      this.$resource.getAllRooms(link).then(({
        data
      }) => {
        this.meta = data.meta;
        this.links = data.links;
...
var HtmlEditor = __webpack_require__(107);
...
var Room = __webpack_require__(175);
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async updateEvent() {
      var _this$event$email_con;

      this.loading = !this.loading;
      const emailMessage = this.convertTextToHtml((_this$event$email_con = this.event.email_content) !== null && _this$event$email_con !== void 0 ? _this$event$email_con : '');
      const converter = new external_showdown_default.a.Converter();
