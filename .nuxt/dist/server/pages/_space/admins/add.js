...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL) {/* harmony import */ var _components_shack_MainTitle_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94);
/* harmony import */ var _components_shack_UploadButton_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(103);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    UploadButton: _components_shack_UploadButton_vue__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]
  },
  ...
  methods: {
    ...
    uploadUrl(url, file, mime) {
      return axios__WEBPACK_IMPORTED_MODULE_2___default.a.put(url, file, {
        headers: {
          'Content-Type': mime
        }
      }).then(res => {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/admins/add.vue?vue&type=template&id=44e7c5f6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('b-form',{on:{"submit":function($event){$event.preventDefault();return _vm.addAdmin($event)}}},[_c('base-header',{staticClass:"pb-6",attrs:{"type":""}},[_c('div',{staticClass:"d-flex justify-content-between align-items-center py-4"},[_c('MainTitle',{attrs:{"title":"Adminstrators","subtitle":"Add Admin"}}),_vm._v(" "),_c('b-button',{staticClass:"btn btn-primary text-white",attrs:{"disabled":_vm.loading,"type":"submit"}},[_vm._v("Add Adminstrator")])],1)]),_vm._v(" "),_c('div',{staticClass:"container-fluid mt--6"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-6"},[_c('card',[_c('div',{staticClass:"d-flex align-items-center mr-b-20"},[_c('img',{staticClass:"mr-r-20 rounded-circle avatar-xl",attrs:{"src":_vm.url ? _vm.url : '/img/placeholder.jpg'}}),_vm._v(" "),_c('div',[_c('div',{staticClass:"upload-btn-wrapper"},[_c('button',{staticClass:"btn btn-outline-primary sh-btn-outline"},[_vm._v("\n                    UPLOAD PHOTO\n                  ")]),_vm._v(" "),_c('input',{attrs:{"type":"file"},on:{"change":_vm.onFileChange}})])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('base-input',{staticClass:"col-md-6",attrs:{"id":"firstName","label":"First Name","placeholder":"First Name"},model:{value:(_vm.first_name),callback:function ($$v) {_vm.first_name=$$v},expression:"first_name"}}),_vm._v(" "),_c('base-input',{staticClass:"col-md-6",attrs:{"id":"lastName","label":"Last Name","placeholder":"Last Name"},model:{value:(_vm.last_name),callback:function ($$v) {_vm.last_name=$$v},expression:"last_name"}}),_vm._v(" "),_c('base-input',{staticClass:"col-md-6",attrs:{"id":"email","label":"Email","placeholder":"Email","type":"email"},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}}),_vm._v(" "),_c('base-input',{staticClass:"col-md-6",attrs:{"id":"password","type":"password","label":"Password","placeholder":"********"},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1)])],1)])])],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_space/admins/add.vue?vue&type=template&id=44e7c5f6&

// EXTERNAL MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_space/admins/add.vue?vue&type=script&lang=js&
var addvue_type_script_lang_js_ = __webpack_require__(132);

// CONCATENATED MODULE: ./pages/_space/admins/add.vue?vue&type=script&lang=js&
 /* harmony default export */ var admins_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_["a" /* default */]); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_space/admins/add.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admins_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
