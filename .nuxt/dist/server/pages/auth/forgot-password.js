...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/auth/forgot-password.vue?vue&type=template&id=d28c30dc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row justify-content-center align-items-center flex-column h-100"},[_vm._ssrNode("<div class=\"col col-sm-6 col-md-6 col-lg-4 col-xl-3 my-auto\">","</div>",[_vm._ssrNode("<form class=\"mr-b-30\">","</form>",[_vm._ssrNode("<img src=\"/img/logo2.png\" alt=\"Shack 15 Logo\" height=\"20px\" class=\"mr-b-20\"> <h1 class=\"mr-b-10\">Forgot Password</h1> <div class=\"mr-b-20 text-success\">"+_vm._ssrEscape(_vm._s(_vm.msg))+"</div> "),_c('base-input',{attrs:{"placeholder":"Email","type":"email","required":""},model:{value:(_vm.user.email),callback:function ($$v) {_vm.$set(_vm.user, "email", $$v)},expression:"user.email"}}),_vm._ssrNode(" "),_c('b-button',{attrs:{"block":"","type":"submit","variant":"outline-dark"}},[_vm._v("RESET PASSWORD")])],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"text-muted\">","</div>",[_vm._ssrNode("\n      Remembered your password?\n      "),_c('nuxt-link',{staticClass:"text-dark",attrs:{"to":{name: 'auth-login'}}},[_c('u',[_vm._v("Login Here")])])],2)],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/auth/forgot-password.vue?vue&type=template&id=d28c30dc&

// EXTERNAL MODULE: ./components/shack/AuthNavbar.vue + 4 modules
var AuthNavbar = __webpack_require__(111);

// CONCATENATED MODULE: ./node_modules/@nuxt/webpack/node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/auth/forgot-password.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var forgot_passwordvue_type_script_lang_js_ = ({
  ...
  methods: {
    resetPassword() {
      this.$authLocal.forgotPassword(this.user.email).then(({
        data
      }) => {
        if (data) {
          this.msg = 'Password reset link sent to your email if it exists in our database';
        }
      });
    }
